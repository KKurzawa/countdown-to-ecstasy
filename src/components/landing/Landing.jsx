    ...
    return (
        <article className='landing w-screen h-screen'>
            <article className='landing-content flex flex-col justify-center items-center w-full h-full text-center gap-10'>
                <section className="landing-title flex gap-5 text-2xl md:text-5xl lg:text-8xl">
                ...
                <section className="landing-subtitle flex gap-5 text-xl md:text-4xl lg:text-7xl">
